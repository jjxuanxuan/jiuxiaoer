...
const maxRedemptionWriteBodySize = 64 << 10
...
func cloneJSON(value datatypes.JSON) datatypes.JSON { return core.CloneJSON(value) }
...
func decodeStrictJSON(c *gin.Context, out any) error {
	reader := http.MaxBytesReader(c.Writer, c.Request.Body, maxRedemptionWriteBodySize)
